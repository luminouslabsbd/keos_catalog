                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-6">
                                <div class="text-end">
                                    <div id="campaign-sent-chart" data-colors="#ffff00"></div>
                                </div>
                            </div>
                        </div> <!-- end row-->
                    </div> <!-- end card-body -->
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-6">
                                <div class="text-end">
                                    <div id="new-leads-chart" data-colors="#ff0000"></div>
                                </div>
                            </div>
                        </div> <!-- end row-->
                    </div> <!-- end card-body -->
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-start">
                            <img class="me-3 rounded-circle" src="{{asset('/')}}assets/backend/images/users/avatar-2.jpg" width="40" alt="Generic placeholder image">
                        ...
                        <div class="d-flex align-items-start mt-3">
                            <img class="me-3 rounded-circle" src="{{asset('/')}}assets/backend/images/users/avatar-3.jpg" width="40" alt="Generic placeholder image">
                            <div class="w-100 overflow-hidden">
                        ...
                        <div class="d-flex align-items-start mt-3">
                            <img class="me-3 rounded-circle" src="{{asset('/')}}assets/backend/images/users/avatar-4.jpg" width="40" alt="Generic placeholder image">
                            <div class="w-100 overflow-hidden">
                        ...
                        <div class="d-flex align-items-start mt-3">
                            <img class="me-3 rounded-circle" src="{{asset('/')}}assets/backend/images/users/avatar-5.jpg" width="40" alt="Generic placeholder image">
                            <div class="w-100 overflow-hidden">
                                <span class="badge badge-warning-lighten float-end">Cold lead</span>
                        ...
                        <div class="d-flex align-items-start mt-3">
                            <img class="me-3 rounded-circle" src="{{asset('/')}}assets/backend/images/users/avatar-1.jpg" width="40" alt="Generic placeholder image">
                            <div class="w-100 overflow-hidden">
                                <span class="badge badge-warning-lighten float-end">Cold lead</span>
                        ...
                        <div class="d-flex align-items-start mt-3">
                            <img class="me-3 rounded-circle" src="{{asset('/')}}assets/backend/images/users/avatar-6.jpg" width="40" alt="Generic placeholder image">
                            <div class="w-100 overflow-hidden">
                                <span class="badge badge-success-lighten float-end">Won lead</span>
                ...
                <div class="card cta-box bg-primary text-white">
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-center">
                            ...
                            <img class="ms-3" src="{{asset('/')}}assets/backend/images/email-campaign.svg" width="120" alt="Generic placeholder image">
                        </div>
                    </div>
                    <!-- end card-body -->
                </div>
